...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralWidget.setMinimumSize(QtCore.QSize(1080, 637))
        ...
        self.label_signalAvg = QtWidgets.QLabel(self.widget_acqOptions)
        self.label_signalAvg.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_signalAvg.setObjectName("label_signalAvg")
        self.gridLayout_6.addWidget(self.label_signalAvg, 3, 0, 1, 1)
        self.lineEdit_signalAvg = QtWidgets.QLineEdit(self.widget_acqOptions)
        self.lineEdit_signalAvg.setObjectName("lineEdit_signalAvg")
        self.gridLayout_6.addWidget(self.lineEdit_signalAvg, 3, 1, 1, 1)
        ...
        self.label_ampVolts = QtWidgets.QLabel(self.groupBox_TxParams)
        self.label_ampVolts.setObjectName("label_ampVolts")
        self.gridLayout_7.addWidget(self.label_ampVolts, 0, 2, 1, 1)
        ...
        self.comboBox_freq = QtWidgets.QComboBox(self.groupBox_TxParams)
        self.comboBox_freq.setObjectName("comboBox_freq")
        self.comboBox_freq.addItem("")
        self.comboBox_freq.addItem("")
        self.gridLayout_7.addWidget(self.comboBox_freq, 1, 2, 1, 1)
        self.verticalLayout_2.addLayout(self.gridLayout_7)
        self.gridLayout.addWidget(self.groupBox_TxParams, 0, 1, 1, 1)
        self.groupBox_transConfig = QtWidgets.QGroupBox(self.centralWidget)
        self.groupBox_transConfig.setObjectName("groupBox_transConfig")
        self.verticalLayout_acqOptions = QtWidgets.QVBoxLayout(self.groupBox_transConfig)
        self.verticalLayout_acqOptions.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        self.verticalLayout_acqOptions.setContentsMargins(11, 11, 11, 11)
        self.verticalLayout_acqOptions.setSpacing(6)
        self.verticalLayout_acqOptions.setObjectName("verticalLayout_acqOptions")
        self.widget_loadTransFile = QtWidgets.QWidget(self.groupBox_transConfig)
        ...
        self.verticalLayout_acqOptions.addWidget(self.widget_loadTransFile)
        self.tableWidget_transConfig = QtWidgets.QTableWidget(self.groupBox_transConfig)
        ...
        self.verticalLayout_acqOptions.addWidget(self.tableWidget_transConfig)
        self.widget_tableOptions = QtWidgets.QWidget(self.groupBox_transConfig)
        self.widget_tableOptions.setObjectName("widget_tableOptions")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.widget_tableOptions)
        self.gridLayout_5.setContentsMargins(11, 11, 11, 11)
        self.gridLayout_5.setSpacing(6)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.pushButton_addRow = QtWidgets.QPushButton(self.widget_tableOptions)
        self.pushButton_addRow.setObjectName("pushButton_addRow")
        self.gridLayout_5.addWidget(self.pushButton_addRow, 0, 1, 1, 1)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_5.addItem(spacerItem3, 0, 0, 1, 1)
        self.verticalLayout_acqOptions.addWidget(self.widget_tableOptions)
        self.gridLayout.addWidget(self.groupBox_transConfig, 0, 0, 2, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_signalAvg.setText(_translate("MainWindow", "Signal Averaging:"))
        ...
        self.label_ampVolts.setText(_translate("MainWindow", "V"))
        self.label_freq.setText(_translate("MainWindow", "Frequency:"))
        self.comboBox_freq.setCurrentText(_translate("MainWindow", "kHz"))
        self.comboBox_freq.setItemText(0, _translate("MainWindow", "kHz"))
        self.comboBox_freq.setItemText(1, _translate("MainWindow", "MHz"))
        self.groupBox_transConfig.setTitle(_translate("MainWindow", "Transducer Configuration"))
